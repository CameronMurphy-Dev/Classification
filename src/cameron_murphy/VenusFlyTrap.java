...
public class VenusFlyTrap extends Species implements AntEater {

	String name;
	int antsEaten;
	
		//Constructor
	public VenusFlyTrap(String kingdom, String tier, String className, String order, String family, String genus, String species,
